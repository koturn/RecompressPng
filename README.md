...
[![Test status](https://ci.appveyor.com/api/projects/status/pic7w57ggpfcs7qx/branch/patch-build-script?svg=true)](https://ci.appveyor.com/project/koturn/recompresspng "AppVeyor | koturn/RecompressPng")
